...
class ServiceBusTopicAdapter:
    ...
    def SendMessage(self, objectToSend, customProperties: Dict[str, str] = None, scheduledEnqueueTimeUtc: datetime = None) -> None:
        message = ServiceBusMessage(body=self.__ConvertToMessage__(objectToSend), user_properties=customProperties, scheduled_enqueue_time_utc=scheduledEnqueueTimeUtc)
